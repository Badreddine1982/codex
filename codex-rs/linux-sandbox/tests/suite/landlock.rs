...
async fn sandbox_blocks_explicit_split_policy_carveouts_under_bwrap() {
    ...
    let file_system_sandbox_policy = FileSystemSandboxPolicy::restricted(vec![
        ...
        FileSystemSandboxEntry {
            path: FileSystemPath::Path {
                path:  AbsolutePathBuf::try_from(sandbox_helper_dir.as_path())
                    .expect("absolute helper dir").into(),
            },
            access: FileSystemAccessMode::Read,
            missing_path_behavior: None,
        },
        FileSystemSandboxEntry {
            path: FileSystemPath::Path {
                path:  AbsolutePathBuf::try_from(tmpdir.path()).expect("absolute tempdir").into(),
            },
        ...
        FileSystemSandboxEntry {
            path: FileSystemPath::Path {
                path:  AbsolutePathBuf::try_from(blocked.as_path()).expect("absolute blocked dir").into(),
            },
...
async fn sandbox_reenables_writable_subpaths_under_unreadable_parents() {
    ...
    let file_system_sandbox_policy = FileSystemSandboxPolicy::restricted(vec![
        ...
        FileSystemSandboxEntry {
            path: FileSystemPath::Path {
                path:  AbsolutePathBuf::try_from(allowed.as_path()).expect("absolute allowed dir").into(),
            },
            access: FileSystemAccessMode::Write,
            missing_path_behavior: None,
        },
